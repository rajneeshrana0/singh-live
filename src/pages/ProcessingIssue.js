      ...
      <div className="mt-8 flex flex-col items-center">
        <div>
          <div className="border-[1px] shadow-sm shadow-darkgray h-[165px] w-[400px] lg:w-[500px] rounded-lg overflow-hidden">
            ...
            <select
              id="lotNumber"
              className="mt-4 focus:ring-darkgray focus:border-darkgray block w-[300px] shadow-sm ml-4 sm:text-sm border-gray-300 rounded-md"
              value={selectedLot}
        ...
        <div className="mt-8 flex items-center ">
          <input
            type="checkbox"
            id="completed"
            className="h-6 w-6 mr- text-darkgray focus:ring-darkgray border-gray-300 rounded"
            checked={completed}
        ...
        <div className="mt-8 flex items-center">
          ...
          >
            {selectedLot
              ? "Work Rejected"
              : "Select Lot Number first to reject"}
          </label>
        </div>
        ...
        {completed && (
          <div className="mt-4 border-[1px] shadow-sm shadow-darkgray h-[165px] w-[400px] lg:w-[500px] rounded-lg overflow-hidden">
            <label
              ...
              className="block text-sm font-medium  ml-4 mt-4 text-gray-700"
            >
              Completion Date
            </label>
            <input
      ...
      <div className="mt-12 w-full">
        <div className="w-full mt-6 bg-white border-nav border-2 rounded-lg">
          <div className="lg:flex ml-4 mt-4 justify-between items-center">
            <div className="text-title font-bold">Process Issue</div>
          ...
          {filteredData.length === 0 ? (
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full mt-6 divide-y divide-gray-200 rounded-lg overflow-hidden">
