  ...
  return (
    <div className="flex flex-col h-screen">
      <div className="bg-blue-500 text-white p-4 flex justify-between">
        <h1 className="text-2xl font-semibold">Gray Stock  Data</h1>
        <input
          type="text"
          placeholder="Search..."
        ...
        <table className="min-w-full divide-y divide-gray-200 rounded-lg overflow-hidden">
          <thead className="bg-blue-500 text-white">
            <tr>
              ...
              <th className="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider">Process</th>
              <th className="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider">Finish</th>
